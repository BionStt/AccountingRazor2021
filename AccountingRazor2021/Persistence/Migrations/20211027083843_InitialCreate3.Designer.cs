...
namespace AccountingRazor2021.Persistence.Migrations
{
    ...
    [Migration("20211027083843_InitialCreate3")]
            ...
            modelBuilder.Entity("AccountingRazor2021.Domain.DataSaldoAwal", b =>
                {
                    ...
                    b.Property<DateTime>("TanggalInput")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 10, 27, 15, 38, 43, 172, DateTimeKind.Local).AddTicks(6814))
                        .HasColumnName("TanggalInput");
            ...
            modelBuilder.Entity("AccountingRazor2021.Domain.DataSaldoHarian", b =>
                {
                    ...
                    b.Property<DateTime>("TanggalInput")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 10, 27, 15, 38, 43, 181, DateTimeKind.Local).AddTicks(4696))
                        .HasColumnName("TanggalInput");
            ...
            modelBuilder.Entity("AccountingRazor2021.Domain.TipeJournal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TipeJournalId = new Guid("63c633e6-551e-4c92-9dc2-3e6d82ddf047"),
                            KodeJournal = "JU",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("a3dda574-96e4-4cfe-ab36-627d258426e9"),
                            KodeJournal = "JPMB",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("de1c8e97-85ce-411c-90c7-b1076c098066"),
                            KodeJournal = "JPJ",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("7a7183ec-65af-418f-a143-23984d879b2c"),
                            KodeJournal = "JPNK",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("9f12a814-1b89-4f7e-9744-66e66c5e1e1e"),
                            KodeJournal = "JPGNK",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("7554f1d5-37dd-41c6-9800-5a27c97bd9e4"),
                            KodeJournal = "JPEY",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("e314a91b-13cd-483f-be2a-988b846f8495"),
                            KodeJournal = "JPMBK",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("1e041cd8-edd5-4b6c-97b1-f32a05ec32b3"),
                            KodeJournal = "JPNTP",
                        ...
                        new
                        {
                            TipeJournalId = new Guid("0950b3a6-1e46-4dd1-ac99-9a1a93f33e33"),
                            KodeJournal = "JPMBLK",
